...
const compromisedImageMappings = [
  ...
  { brand: 'Kilian', name: 'Bad Boys Are No Good But Good Boys Are No Fun', imageFile: 'Kilian – Bad Boys Are No Good But Good Boys Are No Fun_1753551627386.png' },
  { brand: 'Kilian', name: 'Black Phantom', imageFile: 'Kilian – Black Phantom_1753551627387.png' },
  { brand: 'Kilian', name: 'Good Girl Gone Bad', imageFile: 'Kilian – Good Girl Gone Bad_1753551627388.png' },
  { brand: 'Kilian', name: 'Good Girl Gone Bad Extreme', imageFile: 'Kilian – Good Girl Gone Bad Extreme_1753551627388.png' },
  { brand: 'Kilian', name: 'Rolling In Love', imageFile: 'Kilian – Rolling In Love_1753551627389.png' },
  { brand: 'Kilian', name: 'Roses On Ice', imageFile: 'Kilian – Roses On Ice_1753551627390.png' },
  
  // Gucci luxury collection (4 products)
  { brand: 'Gucci', name: 'Bloom', imageFile: 'Gucci – Bloom_1753551333696.png' },
  { brand: 'Gucci', name: 'Flora Gorgeous Gardenia', imageFile: 'Gucci – Flora Gorgeous Gardenia_1753551333696.png' },
  { brand: 'Gucci', name: 'Flora Gorgeous Jasmine', imageFile: 'Gucci – Flora Gorgeous Jasmine_1753551333696.png' },
  { brand: 'Gucci', name: 'Flora Gorgeous Orchid', imageFile: 'Gucci – Flora Gorgeous Orchid_1753551333697.png' },
  
  // Dior luxury collection (5 products)
  { brand: 'Dior', name: 'J\'adore', imageFile: 'Dior – J\'adore_1753551242328.png' },
  { brand: 'Dior', name: 'Joy', imageFile: 'Dior – Joy_1753551242329.png' },
  { brand: 'Dior', name: 'Joy Intense', imageFile: 'Dior – Joy Intense_1753551242328.png' },
  { brand: 'Dior', name: 'Miss Dior (EDP)', imageFile: 'Dior – Miss Dior (EDP)_1753551242329.png' },
  { brand: 'Dior', name: 'Miss Dior Blooming Bouquet', imageFile: 'Dior – Miss Dior Blooming Bouquet_1753551242330.png' },
  ...
  { brand: 'Givenchy', name: 'Society', imageFile: 'Givenchy – Society_1753551333695.png' },
  
  // Hermes luxury (1 product)
  { brand: 'Hermes', name: 'Merveilles', imageFile: 'Hermes – Merveilles_1753551333697.png' },
  
  // Lancome luxury (1 product)
  { brand: 'Lancome', name: 'Climat', imageFile: 'Lancome – Climat_1753551627390.png' },
  
  // Paco Rabanne (1 product)
  { brand: 'Paco Rabanne', name: 'Pure XS For Her', imageFile: 'Paco Rabanne – Pure XS For Her_1753552335217.png' }
];
